...
INSERT INTO "new_Task" ("assigneeId", "circleId", "completedAt", "createdAt", "createdById", "description", "dueDate", "id", "position", "status", "title", "updatedAt") SELECT "assigneeId", "circleId", "completedAt", "createdAt", "createdById", "description", "dueDate", "id", "position", "status", "title", "updatedAt" FROM "Task";
DROP TABLE "Task";
